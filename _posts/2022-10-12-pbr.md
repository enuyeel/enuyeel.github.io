...
You can check out the different shapes of NDFs [**here**](https://www.desmos.com/calculator/ewcjfzvfnk), and play around with them to figure out which would be the fittest for your application.
...
With a bit of algebra chain, we can arrive at the form which better suits our notation:<br>
...
$$G(v,l,\alpha)=\frac{1}{1+\Lambda(v,\alpha)+\Lambda(l,\alpha)}$$

$$1+\Lambda(v,\alpha)+\Lambda(l,\alpha)=\frac{1}{2}(\frac{\sqrt{\alpha^2+(1-\alpha^2)(n\cdot v)^2}}{n\cdot v}+\frac{\sqrt{\alpha^2+(1-\alpha^2)(n\cdot l)^2}}{n\cdot l})$$
...
**Bibliograph**<br>
[[**Heitz14a**]](https://jcgt.org/published/0003/02/03/paper.pdf) Eric Heitz. 2014. Understanding the Masking-Shadowing Function in Microfacet-Based BRDFs (Paper).
[[**Heitz14b**]](https://jcgt.org/published/0003/02/03/presentation.pdf) Eric Heitz. 2014. Understanding the Masking-Shadowing Function in Microfacet-Based BRDFs (Presentation).
